...
venue: "The Florey (co-hosted by MIG and WEHI)"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
address: "Florey Institute, Level 5 Seminar Room, Building 185"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
humandate: "April 04, 2024"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:30 am - 12:30 pm AEST"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
...
If you prefer avoid installing Jupyter, or are having troubles to install it, use <a href="https://jupyter.org/try-jupyter/lab/">Try Jupyter</a>. Download the python-novice-inflammation-data.zip described in the setup, and use the "Upload files" button at the top of the sidebar (to the left of the screen, above the search bar, next to the "+" button).
